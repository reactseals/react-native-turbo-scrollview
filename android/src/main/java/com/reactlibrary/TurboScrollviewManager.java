...
import com.reactlibrary.TurboScrollview;
import com.reactlibrary.TurboScrollviewCommandHelper;
import com.reactlibrary.TurboScrollviewHelper;
...
public class TurboScrollviewManager extends ViewGroupManager<TurboScrollview>
        implements TurboScrollviewCommandHelper.ScrollCommandHandler<TurboScrollview> {
    ...
    public TurboScrollviewManager() {
        this(null);
    }

    public TurboScrollviewManager(@Nullable FpsListener fpsListener) {
    ...
    @Override
    public TurboScrollview createViewInstance(ThemedReactContext context) {
        return new TurboScrollview(context);
    }

    @ReactProp(name = "scrollEnabled", defaultBoolean = true)
    public void setScrollEnabled(TurboScrollview view, boolean value) {
        view.setScrollEnabled(value);
    }

    @ReactProp(name = "showsVerticalScrollIndicator")
    public void setShowsVerticalScrollIndicator(TurboScrollview view, boolean value) {
        view.setVerticalScrollBarEnabled(value);
    }

    @ReactProp(name = "decelerationRate")
    public void setDecelerationRate(TurboScrollview view, float decelerationRate) {
        view.setDecelerationRate(decelerationRate);
    }

    @ReactProp(name = "snapToInterval")
    public void setSnapToInterval(TurboScrollview view, float snapToInterval) {
    ...
    public void setSnapToOffsets(TurboScrollview view, @Nullable ReadableArray snapToOffsets) {
        DisplayMetrics screenDisplayMetrics = DisplayMetricsHolder.getScreenDisplayMetrics();
    ...
    public void setSnapToEnd(TurboScrollview view, boolean snapToEnd) {
        view.setSnapToEnd(snapToEnd);
    }

    @ReactProp(name = ReactClippingViewGroupHelper.PROP_REMOVE_CLIPPED_SUBVIEWS)
    public void setRemoveClippedSubviews(TurboScrollview view, boolean removeClippedSubviews) {
    ...
    public void setSendMomentumEvents(TurboScrollview view, boolean sendMomentumEvents) {
    ...
    public void setScrollPerfTag(TurboScrollview view, @Nullable String scrollPerfTag) {
        view.setScrollPerfTag(scrollPerfTag);
    }

    @ReactProp(name = "pagingEnabled")
    public void setPagingEnabled(TurboScrollview view, boolean pagingEnabled) {
    ...
    public void setBottomFillColor(TurboScrollview view, int color) {
    ...
    public void setOverScrollMode(TurboScrollview view, String value) {
        view.setOverScrollMode(TurboScrollviewHelper.parseOverScrollMode(value));
    }

    @ReactProp(name = "nestedScrollEnabled")
    public void setNestedScrollEnabled(TurboScrollview view, boolean value) {
        ViewCompat.setNestedScrollingEnabled(view, value);
    }

    @Override
    public @Nullable Map<String, Integer> getCommandsMap() {
        return TurboScrollviewCommandHelper.getCommandsMap();
    }

    @Override
    public void receiveCommand(TurboScrollview scrollView, int commandId, @Nullable ReadableArray args) {
        TurboScrollviewCommandHelper.receiveCommand(this, scrollView, commandId, args);
    }

    @Override
    public void flashScrollIndicators(TurboScrollview scrollView) {
        scrollView.flashScrollIndicators();
    }

    @Override
    public void scrollTo(TurboScrollview scrollView, TurboScrollviewCommandHelper.ScrollToCommandData data) {
    ...
    public void setBorderRadius(TurboScrollview view, int index, float borderRadius) {
    ...
    public void setBorderStyle(TurboScrollview view, @Nullable String borderStyle) {
    ...
    public void setBorderWidth(TurboScrollview view, int index, float width) {
    ...
    public void setBorderColor(TurboScrollview view, int index, Integer color) {
    ...
    public void setOverflow(TurboScrollview view, @Nullable String overflow) {
        view.setOverflow(overflow);
    }

    @Override
    public void scrollToEnd(TurboScrollview scrollView, TurboScrollviewCommandHelper.ScrollToEndCommandData data) {
    ...
    public void setPersistentScrollbar(TurboScrollview view, boolean value) {
